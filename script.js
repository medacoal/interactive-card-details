...
form.addEventListener("submit", (e) => { 
   // CARDHOLDER NAME
   // regular expression (regex) to check if the input value in `cardFrontCodeInput` contains at least one letter (either uppercase or lowercase).
